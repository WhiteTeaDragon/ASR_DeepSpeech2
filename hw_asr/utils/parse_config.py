...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, run_id=None):
        ...
        self.log_levels = {0: logging.WARNING, 1: logging.INFO,
                           2: logging.DEBUG}
    ...
    def from_args(cls, args, options=""):
        ...
        if args.resume is not None:
            ...
            msg_no_cfg = "Configuration file need to be specified. Add '-c " \
        ...
        modification = {
            opt.target: getattr(args, _get_opt_name(opt.flags)) for opt in
            options
        }
